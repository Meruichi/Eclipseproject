...
<%@page import="com.koreait.daoday11.DBConnection"%>
<%@page import="com.koreait.daoday11.MemberDAO"%>
...
<body>
	<jsp:useBean id="member" class="com.koreait.beansday11.MemberBean"/>
...
<%--	<jsp:setProperty property="userid" name="member"/>
	...
	%>
		<script>
			alert("회원가입 성공!");
			location.href="login_view_day11.jsp"
		</script>	
	<%	} else{ // 회원가입 실패 %>
		<script>
			alert("회원가입 실패!");
			location.href="join_view_day11.jsp";
		</script>
	<% } %>

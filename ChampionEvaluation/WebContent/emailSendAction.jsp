...
<%
	...
	if(emailChecked == true){
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("alert('이미 인증 완료된 회원입니다.');");
	...
	String host = "http://localhost:9090/Champion_Evaluation/";
	String from = "lsh12031237@gmail.com";
	String to = userDAO.getUserEmail(userID);
	String subject = "챔피언 평가를 위한 이메일 인증 메일입니다.";
	String content = "다음 링크에 저속하여 이메일 인증을 진행해주세요" +
...
%>
	...
	<!-- 수정한 부분 시작 -->
		<div class="alert alert-success mt-4" role="alert">
			이메일 주소 인증 메일이 전송되었습니다. 회원가입 시 입력했던 이메일을 확인해서 인증해주세요.
		</div>
	</section>
